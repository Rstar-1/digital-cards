...
const Projects = () => {
 const products = [
  ...
  return (
    <div className="bg-ec ptpx40 pbpx40 sm-ptpx20 sm-pbpx20" id="product">
      <div className="flex justify-center">
        <h4 className="textprimary font-600 mtpx1 mbpx1 fsize35 sm-fsize23">
          Our
          <span className="textsecondary mlpx5">Products</span>
        </h4>
      </div>
        ...
        <div className="mtpx25 sm-mtpx5">
          <div className="mtpx20">
            ...
            >
              {products.map((e) => (
                <SwiperSlide>
                  <div className="p10 bgwhite rounded-5">
                    <img
                      src={e.img}
                      alt="project"
                      className="project-img object-contain"
                    />
                    <div className="bg-fa prpx12 plpx12 ptpx8 pbpx8 rounded-15">
